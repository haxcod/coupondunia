...
async function seedDemoContent(): Promise<void> {
  ...
  const topCategoryDefs = [
    ...
    { name: 'Outdoor Living', showOnHomepage: false, order: 6 },
    { name: 'Accessories', showOnHomepage: false, order: 7 },
    { name: 'Health & Wellness', showOnHomepage: false, order: 8 },
    { name: 'Shoes', showOnHomepage: false, order: 9 },
    { name: 'Women\'s Apparel', showOnHomepage: false, order: 10 },
    { name: 'Eyewear', showOnHomepage: false, order: 11 },
    { name: 'Swimwear', showOnHomepage: false, order: 12 },
    { name: 'Men\'s Apparel', showOnHomepage: false, order: 13 },
    { name: 'Flowers', showOnHomepage: false, order: 14 },
    { name: 'Bed & Bath', showOnHomepage: false, order: 15 },
    { name: 'Kids Apparel', showOnHomepage: false, order: 16 },
    { name: 'Home Decor', showOnHomepage: false, order: 17 },
    { name: 'Tech', showOnHomepage: false, order: 18 },
    { name: 'Baby', showOnHomepage: false, order: 19 },
    { name: 'Pet', showOnHomepage: false, order: 20 },
    { name: 'Toys & Games', showOnHomepage: false, order: 21 },
  ];
