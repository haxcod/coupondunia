/**
 * `/api/admin/products/[id]` — admin single-product endpoint (Task 15.1, 15.7).
 *
 *   GET         → full editable product detail for the edit form (Req 16.4–16.14)
 *   PUT / PATCH → update a product from a validated body (Req 16.4–16.8)
 *   DELETE      → delete a product (Req 16.1)
 *
 ...
 * projection includes the affiliate URL because it is only ever returned over
...
import { deleteProduct, getAdminProduct, updateProduct } from '@/lib/catalog';
